  ...
  <div>
    <CRow>
      <CCol col>
        <CCard>
          <CCardHeader>
            <strong> Modulo de Reporte - Recargas</strong>
          </CCardHeader>
          <CCardBody>
...
function SearchReport() {
  ...
  let me = this;
  let url = this.url_base + "report/recharge";
...
function Excel() {
  ...
  let url = this.url_base + "excel-recharge/"+ this.report.id_client+"/"+ this.report.id_user+"/"+ 
